...
Not a framework to write with, but the selector for the ones below. _Breakthrough Advertising_ (1966) sorts readers by how much they already know, and the stage decides what the headline can do: copy cannot create desire, only channel the desire the reader arrived with.
...
2. **Interest.** Why it's relevant to _them_ specifically.
...
**Test:** Does this sentence describe what the product _has_ or what the user _gets_?
