...
Behavioral segments group people by how they _think_ about a domain — not by demographics. Two people with the same job title, age, and industry may reason completely differently about the same activity. Behavioral segments surface these differences and give design teams a foundation for supporting distinct intents.
...
| Understanding _why_ users behave differently | Behavioral segments                     |
