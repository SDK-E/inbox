...
4. Trusted primary sources.

Do not rely on memory when current evidence is available. If evidence is unclear or conflicting, investigate further before editing code.
