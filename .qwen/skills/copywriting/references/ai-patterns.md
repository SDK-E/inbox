...
The structural catalogue above tracks Wikipedia's _Signs of AI writing_ (https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), which is maintained against live examples and revised as models change. Two things it records that matter here:
