      ...
      <ScrollArea className="flex-1">
        <div className="max-w-3xl mx-auto p-6">
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Select a message from the list to read it here. This is your
              reader pane where you can view the full content of your emails.
            </p>

            <div className="rounded-lg border border-border bg-surface p-4">
              <h2 className="text-lg font-medium mb-2">Getting Started</h2>
              <p className="text-sm text-muted-foreground mb-4">
                Inbox helps you manage multiple email accounts in one place. Use
                the sidebar to navigate between folders, and the command palette
                (Cmd+K or Ctrl+K) to quickly find what you need.
              </p>
